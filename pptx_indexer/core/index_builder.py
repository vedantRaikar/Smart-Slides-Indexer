...
from ..schemas.document_index import DocumentIndex, DocumentStats
from ..schemas.slide_graph_schema import SlideGraph
from ..plugins.base_llm import BaseLLM
from ..plugins.base_llm import BaseEmbedder, BaseVectorStore, BaseOCR, BaseImageCaptioner
...
class IndexBuilder:
    ...
    def _compute_statistics(self, index: DocumentIndex, slides: List[SlideNode]) -> None:
        ...
        # Count words
        total_words = sum(
           len(s.get_full_text().split()) for s in slides
        )
